...
The first release is `v0.1.0`. Its annotated tag and GitHub Release were published after hosted CI and CodeQL passed. `docs/release-notes.md` and `docs/release-checklist.md` record the verified release state.
